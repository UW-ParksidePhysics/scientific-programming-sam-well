...
#the numbers were chosen from Sam's birthdate, which is 05/31

r = arrow(pos=vector(0, 0, 0), axis=vector(5, 3, 1), color=color.yellow, shaftwidth=0.5)
rlbl = label(pos=vector(0, 0, 0), text="r = 5x+3y+1z", color=color.black, box=0)
